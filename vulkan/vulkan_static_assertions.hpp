...
VULKAN_HPP_STATIC_ASSERT( sizeof( VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL ) == sizeof( VkTestFrameworkDispatcherConfigurationINTEL ), "struct and wrapper have different size!" );
VULKAN_HPP_STATIC_ASSERT( std::is_standard_layout<VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL>::value, "struct wrapper is not a standard layout!" );
VULKAN_HPP_STATIC_ASSERT( std::is_nothrow_move_constructible<VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL>::value, "TestFrameworkDispatcherConfigurationINTEL is not nothrow_move_constructible!" );
