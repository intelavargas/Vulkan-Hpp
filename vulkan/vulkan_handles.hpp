...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  struct TestFrameworkDispatcherConfigurationINTEL;
...
#  endif /* VULKAN_HPP_NO_SMART_HANDLE */
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
    ...
    template <typename Dispatch = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE>
    void testFrameworkDispatcherINTEL( VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL * testFrameworkDispatcherConfiguration, Dispatch const & d  VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const VULKAN_HPP_NOEXCEPT;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    template <typename Dispatch = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE>
    VULKAN_HPP_NODISCARD VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL testFrameworkDispatcherINTEL( Dispatch const & d VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const VULKAN_HPP_NOEXCEPT;
#endif /* VULKAN_HPP_DISABLE_ENHANCED_MODE */
