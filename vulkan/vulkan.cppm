...
using VULKAN_HPP_DEFAULT_DISPATCHER_TYPE;
  ...
  using VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherFunctionINTEL;
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
  using VULKAN_HPP_NAMESPACE::INTELTestFrameworkSupportExtensionName;
  using VULKAN_HPP_NAMESPACE::INTELTestFrameworkSupportSpecVersion;
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
  using VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL;
