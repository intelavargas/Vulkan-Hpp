...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string( TestFrameworkDispatcherFunctionINTEL value )
  {
    switch ( value )
    {
      case TestFrameworkDispatcherFunctionINTEL::e0 : return "0";
      case TestFrameworkDispatcherFunctionINTEL::e1 : return "1";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
