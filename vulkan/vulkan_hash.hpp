...
template <> struct hash<VULKAN_HPP_NAMESPACE::SurfaceFullScreenExclusiveWin32InfoEXT>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::TestFrameworkDispatcherConfigurationINTEL const & testFrameworkDispatcherConfigurationINTEL) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, testFrameworkDispatcherConfigurationINTEL.function );
    VULKAN_HPP_HASH_COMBINE( seed, testFrameworkDispatcherConfigurationINTEL.data );
      return seed;
    }
  };
